                  ...
                  <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="bg-pink-50 rounded-lg px-4 py-2">
                        <p className="text-gray-700 text-sm">XXXX高校</p>
                      </div>
                      <div className="bg-pink-50 rounded-lg px-4 py-2">
                        <p className="text-gray-700 text-sm">XXXX小学校</p>
                      </div>
                      <div className="bg-pink-50 rounded-lg px-4 py-2">
                        <p className="text-gray-700 text-sm">XXXX市</p>
                      </div>
                      <div className="bg-pink-50 rounded-lg px-4 py-2">
                        <p className="text-gray-700 text-sm">XXXX教育委員会</p>
                      </div>
                    </div>
                  </div>
